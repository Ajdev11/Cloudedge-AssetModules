		...
		?>
			...
			<form name="insertrecord" method="post">
				...
				<div class="row">
					...
					<div class="col-7 my-2">
						<input style="background:orange" type="text" id="" name="address1" value="<?php echo htmlentities($row['address']); ?>" class="form-control">
				...
				<div class="row">
					...
					<div class="col-7 my-2">
						<input style="background:orange" type="text" id="" name="plots1" value="<?php echo htmlentities($row['no_of_plots']); ?>" class="form-control" required>
				...
				<div class="row">
					...
					<div class="col-7 my-2">
						<input style="background:orange" type="text" id="" name="cost1" value="<?php echo htmlentities($row['cost_price']); ?>" class="form-control" required>
				...
				<div class="row">
					...
					<div class="col-7 my-2">
						<input style="background:orange" id="" name="yearPurchased1" value="<?php echo htmlentities($row['year_of_purchase']); ?>" class="form-control">
				...
				<div class="row">
					...
					<div class="col-7">
						<input style="background:orange" type="text" id="" name="fullypaid1" value="<?php echo htmlentities($row['fullypaid']); ?>" class="form-control">
				...
				<div class="row">
					...
					<div class="col-7">
						<input style="background:orange" type="text" id="" name="litig1" value="<?php echo htmlentities($row['litig']); ?>" class="form-control">
