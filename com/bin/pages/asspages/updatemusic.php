      ...
      <?php 
        ...
        ?>
         ...
         <div class="col-7">
          ...
          <input type="text" name="categoryName1" value="<?php echo htmlentities($row['item_category']); ?>" class="form-control" required>
       ...
       <div class="col-7">
          ...
          <div class="col-5 my-2">
          <input type="text" name="subcateg1" value="<?php echo htmlentities($row['item_type']); ?>" class="form-control" required>
       ...
       <div class="col-7">
          ...
          <div class="col-5 my-2">
          <input type="text" name="assetName1" value="<?php echo htmlentities($row['assetName']); ?>" class="form-control" required>
       ...
       <div class="row">
          ...
          <div class="col-5 my-2">
          <input type="text" name="manufacturer1" value="<?php echo htmlentities($row['oem']); ?>" class="form-control" required>
          ...
          <div class="col-5 my-2">
          <input type="text" name="model1" value="<?php echo htmlentities($row['model']); ?>" class="form-control" required>
          ...
          <div class="col-5 my-2">
          <input type="text" name="sn1" value="<?php echo htmlentities($row['sn']); ?>" class="form-control" required>
          ...
          <div class="col-5 my-2">
          <input type="text" name="dop1" value="<?php echo htmlentities($row['dop']); ?>" class="form-control" required>
          ...
          <div class="col-5 my-2">
          <input type="text" name="cap1" value="<?php echo htmlentities($row['cap']); ?>" class="form-control" required>
          ...
          <div class="col-5 my-2">
          <input type="text" name="assetLocation1" value="<?php echo htmlentities($row['location']); ?>" class="form-control" required>
          ...
          <div class="col-5 my-2">
          <input type="text" name="assetStatus1" value="<?php echo htmlentities($row['status']); ?>" class="form-control" required>
