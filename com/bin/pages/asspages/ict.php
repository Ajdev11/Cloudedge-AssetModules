...
<html lang="en">
  ...
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color:#00ff5573;">
    <img id="logo"  src="img/clogo.png" width="5%">&nbsp;&nbsp;&nbsp;&nbsp;ICT/Electrical/Electronics Assets Management
    </nav>
      <!-- back button -->
      <a class="back" href="asspage.php"><button id="btn" class = "btn btn-dark ">HOME</button></a>
      
    </button> &nbsp; <a href="assetsict.php"> <button class="btn btn-success" value="View ICT Assets">View Assets</button></a>
    <center>
