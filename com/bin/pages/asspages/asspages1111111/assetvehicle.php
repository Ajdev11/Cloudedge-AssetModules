  ...
  <div id="cont" class="container-fluid">
    <nav class="navbar" style="background-color:rgba(100, 200, 60, 1.0);";>
      <div class="row">
        ...
        <div class="col-9">
          <h3 class="center">Asset Management System</h3>
        </div>
      </div>

    </nav>

    <h3 class="cent">MY DISTRICT VEHICLE ASSET LIST</h3>
    <center>
        <!-- <a href="asspage.php" class="btn btn-dark mb-3">Home</a> -->
        <a href="asspage.php" class="btn btn-dark mb-3">Asset Page</a>
        <a onclick="showopts('cal')" class="btn btn-dark mb-3">view Asset List</a>
        <a href="vehicles.php" class="btn btn-dark mb-3">Add New Asset</a>
    </center>
