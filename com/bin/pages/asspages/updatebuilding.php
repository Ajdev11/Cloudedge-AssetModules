...
<body>
    <div class="container-fluid cont bg-secondary text-white">
        ...
        ?>
            ...
            while ($row = mysqli_fetch_array($sql)) {
            ?>
                <h2 class="text-center">Edit Building Record</h2>
                <hr>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <input style="background: #ddd" type="text" name="assetName" value="<?php echo htmlentities($row['assetName']); ?>" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-7 my-2">
                        <input style="background: #ddd" type="text" id="plan1" name="plan1" value="<?php echo htmlentities($row['building_plan']); ?>" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-7 my-2">
                        <input style="background: #ddd" type="text" name="fenced1" value="<?php echo htmlentities($row['fenced']); ?>" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-7 my-2">
                        <input style="background: #ddd" min="0" step="1" type="number" name="no_floors1" value="<?php echo htmlentities($row['no_of_floors']); ?>" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <input style="background: #ddd" type="text" name="natGrid1" value="<?php echo htmlentities($row['national_grid']); ?>" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-5 my-2 text-info">
                ...
                <div class="row">
                    ...
                    <div class="col-7 my-2">
                        <input style="background: #ddd" min="0" step="1" type="number" name="costPrice1" value="<?php echo htmlentities($row['cost_price']); ?>" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-5 my-2 text-info">
                ...
                <div class="row">
                    ...
                    <div class="col-7 my-2">
                        <input style="background: #ddd" type="text" name="address1" value="<?php echo htmlentities($row['address']); ?>" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-5 text-info my-2">
                    ...
                    <div class="col-7 my-2">
                        <input class="form-control form-control-md" name="address" type="text" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-5 my-2">
                    ...
                    <div class="col-7">
                        <input style="background: #ddd" type="text" name="yearCompleted1" value="<?php echo htmlentities($row['year_completed']); ?>" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-5 my-2 text-info">
                    ...
                    <div class="col-7 my-2">
                        <select name="yearCompleted" class="form-select">
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <input style="background: #ddd" type="text" name="status1" value="<?php echo htmlentities($row['current_status']); ?>" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-5 text-info my-2">
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <input style="background: #ddd" type="text" name="assetHolder1" value="<?php echo htmlentities($row['asset_holder']); ?>" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-5 my-2 text-info">
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <input style="background: #ddd" type="text" name="usage1" value="<?php echo htmlentities($row['usage']); ?>" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-5 my-2 text-info">
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <input style="background: #ddd" type="text" name="buildingMaterial1" value="<?php echo htmlentities($row['building_material']); ?>" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-5 text-info my-2">
                    ...
                    <div class="col-7 my-2">
                        <select name="buildingMaterial" class="form-select">
                ...
                <br>
                <p class="text-center">SELLER INFORMATIONS</p>
                <hr>
                ...
                <div class="row">
                    ...
                    <div class="col-7 my-2">
                        <input style="background: #ddd" type="text" name="origOwnerName1" value="<?php echo htmlentities($row['orig_owner_name']); ?>" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7 my-2">
                        <input style="background: #ddd" type="text" name="origOwnerAddress1" value="<?php echo htmlentities($row['orig_owner_address']); ?>" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-5 text-info my-2">
                ...
                <div class="row">
                    ...
                    <div class="col-7 my-2">
                        <input style="background: #ddd" min="0" step="1" type="number" name="origOwnerPhone1" value="<?php echo htmlentities($row['orig_owner_phone']); ?>" class="form-control" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-5 text-info my-2">
