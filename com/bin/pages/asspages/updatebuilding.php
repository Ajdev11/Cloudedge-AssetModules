...
<body>
    ...
    ?>
            ...
            <div class="row">
                ...
                <div class="col-7">
                    <input style="background:orange" type="text" name="assetName"
            ...
            <div class="row">
                ...
                <div class="col-5">
                    <input style="background:orange" type="text" name="yearCompleted1"
                        value="<?php echo htmlentities($row['year_completed']); ?>" class="form-control" required>
