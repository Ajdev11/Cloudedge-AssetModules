...
<body>
  ...
  <center>
    ...
    if (isset($_POST['submitL'])) {
      ...
      $assetInsert = $alist->saveLand($assetCategory, $assetName, $address, $no_of_plots, $larea, $cp, $yearPurchased, $fenced, $currStatus, $origOwnerName, $origOwnerAddress, $origOwnerPhone, $transName, $transPhone, $surveyPlan, $deed, $receipt, $cofo, $natGrid, $assetHolder, $usage);
