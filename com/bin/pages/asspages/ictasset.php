...
<body>
  <div id="cont" class="container-fluid">
    ...
    <center>
        ...
        <a onclick="showopts('cal')" class="btn btn-dark mb-3">Electrical Asset List</a>
    ...
    <p class="text-muted">To update or Delete an Asset from the list, click under the "Action" column of the row.</p>
    <div id="tricaldiv">
