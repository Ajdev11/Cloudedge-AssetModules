...
if (isset($_POST['update'])) {
  ...
  $cap = $_POST['cap'];
  $loc = $_POST['location'];
  $sql = $updatedata->updateVehicle($assetName, $categ, $subCateg, $qty,$dop,$cap,$loc, $status, $id);
...
<body>
  ...
  <div class="container-fluid cont">
    ...
    ?>
<h2>Edit Furniture Record</h2><hr>
      ...
      <div class="row">
        ...
        <div class="col-7">
        <input style = "background:orange" type="text" id="plan1" name="plan1" value="<?php echo htmlentities($row['assetName']); ?>" class="form-control" required>
